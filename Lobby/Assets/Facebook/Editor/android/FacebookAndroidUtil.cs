...
namespace UnityEditor.FacebookEditor
{
    ...
    public class FacebookAndroidUtil
    {
        ...
        private static string debugKeyHash = string.Empty;
        ...
        public static bool SetupProperly
        {
            get
            {
                return DebugKeyHash != string.Empty;
            }
        }
...
//				{
//					string s = System.Environment.GetEnvironmentVariable("HOMEDRIVE");
//					string d = System.Environment.GetEnvironmentVariable("HOMEPATH");
//					string total = s+d+@"\.android\debug.keystore";
//					return total;
//				}
//				return "";
            }
