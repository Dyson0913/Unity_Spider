 ...
 */
    ...
    internal class LogView : ConsoleBase
    {
		...
		private static bool islogShow = false;
		private static string btn_str = "displayLog";
        ...
        protected void OnGUI()
        {
			...
			//if (this.Button(btn_str))
		    {
				//btn_str = btn_str == "displayLog" ? "hide" : "displayLog";
		                //this.GoBack();
				//if( btn_str == "hide") return;
			}
